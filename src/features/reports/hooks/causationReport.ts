...
export const useCausationReportPage = () => {
  ...
  const urlGet = `${urlApiAccounting}/api/v1/account-statement/report/causation`;
  ...
  const downloadCollection = useCallback(() => {
    ...
    const url = new URL(
      `${urlApiAccounting}/api/v1/account-statement/report/generate-causation-xlsx`
    );
